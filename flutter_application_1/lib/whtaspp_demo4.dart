...
class ModelClassWhatsApp extends StatefulWidget {
  const ModelClassWhatsApp({super.key});

  @override
  State<ModelClassWhatsApp> createState() => _ModelClassWhatsAppState();
}

class _ModelClassWhatsAppState extends State<ModelClassWhatsApp> {
  List<WhatsApp> data = [
    WhatsApp(
